...
The MVP suite creates its own saved scene and then runs the focused bootstrap, MVP, asset/material, asset-resource/cloud, physics, sound, prefab, matrix-core, project-file/input, script-introspection, reference, network, script/animation, and particle checks against it:
