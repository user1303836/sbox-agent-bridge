...
internal static class CommandDispatcher
{
	public static BridgeResponse Dispatch( BridgeRequest request )
	{
		return request.Action switch
		{
			...
			"script.list" => ScriptHandlers.List( request ),
			"script.read" => ScriptHandlers.Read( request ),
			"script.search" => ScriptHandlers.Search( request ),
			"script.analyze" => ScriptHandlers.Analyze( request ),
			...
			"scene.metadata" => SceneHandlers.Metadata( request ),
			"scene.find" => SceneHandlers.Find( request ),
			"scene.find_in_radius" => SceneHandlers.FindInRadius( request ),
