...
internal static class CommandDispatcher
{
	public static BridgeResponse Dispatch( BridgeRequest request )
	{
		return request.Action switch
		{
			...
			"bridge.doctor" => EditorHandlers.Doctor( request ),
			...
			"editor.recover_scene" => EditorHandlers.RecoverScene( request ),
			...
			"asset.preview_model" => AssetHandlers.PreviewModel( request ),
			...
			"sound.inspect" => SoundHandlers.Inspect( request ),
			...
			"runtime.list_test_actions" => RuntimeHandlers.ListTestActions( request ),
			"runtime.run_test_action" => RuntimeHandlers.RunTestAction( request ),
			...
			"prefab.inspect_instance" => PrefabHandlers.InspectInstance( request ),
